...
$(function () {
    ...
    */
     ...
     */
        ...
        it('the menu visibility appears when clicked and disappears when clicked again', function () {
     ...
     */
     ...
     beforeEach(function (done) {
        ...
        it('load Feed returns at least one .entry element', function(done) {
     ...
     describe('New Feed Selection', function () {
      ...
      it('content should change when a new feed is loaded', function(done) {
        window.loadFeed(1, function() {
          expect($('.feed').html() !== entries).toBeTruthy();
          done();
        });
      });
     });
